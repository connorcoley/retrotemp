...
class RetroTempPrioritizer():
    ...
    def restore(self, weight_path=os.path.join(project_root, 'models', '5d4M_Reaxys_len2048', 'model.ckpt-47547.as_numpy.pickle')):
...
if __name__ == '__main__':
    ...
    model.restore(os.path.join(project_root, 'models', '5d4M_Reaxys_len2048', 'model.ckpt-47547.as_numpy.pickle'))
